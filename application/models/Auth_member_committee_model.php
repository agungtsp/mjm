...
class Auth_member_committee_model extends  CI_Model{
	
	var $table 		= 'auth_member_committee';
	var $tableAs 	= 'auth_member_committee a';
...
/* End of file auth_member_committee_model.php */
/* Location: ./application/model/auth_member_committee_model.php */